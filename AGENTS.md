...
This project is indexed by GitNexus as **arca-next** (470 symbols, 871 relationships, 16 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
