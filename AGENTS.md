...
This project is indexed by GitNexus as **arca-next** (433 symbols, 716 relationships, 21 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
