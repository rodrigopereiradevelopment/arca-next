...
This project is indexed by GitNexus as **arca-next** (421 symbols, 822 relationships, 16 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
